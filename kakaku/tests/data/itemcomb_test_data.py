...
item_list_case_1 = {
    ...
    "result": {
        ...
        "静岡本店": {
            "items": [
                {"itemname": "となりのトトロ", "price": 1900},
                {"itemname": "ゲド戦記", "price": 1800},
            ],
            "postage": 300,
            "sum_pos_out": 3700,
        },
        "駿河屋": {
            "items": [{"itemname": "風の谷のナウシカ", "price": 1500}],
            "postage": 240,
            "sum_pos_out": 1500,
        },
    },
...
item_list_case_2 = {
    ...
    "result": {
        ...
        "sum_postage": 540,
        "静岡本店": {
            "items": [{"itemname": "耳をすませば", "price": 1900}],
            "postage": 300,
            "sum_pos_out": 1900,
        },
        "駿河屋": {
            "items": [
                {"itemname": "もののけ姫", "price": 2200},
                {"itemname": "千と千尋の神隠し", "price": 1200},
            ],
            "postage": 240,
            "sum_pos_out": 3400,
        },
...
item_list_case_3 = {
    ...
    "result": {
        ...
        "sum_postage": 1190,
        "うねめ通り": {
            "items": [{"itemname": "帰ってきたドラえもん", "price": 2211}],
            "postage": 300,
            "sum_pos_out": 2211,
        },
        "静岡本店": {
            "items": [{"itemname": "機動戦士ガンダム", "price": 1912}],
            "postage": 300,
            "sum_pos_out": 1912,
        },
        "駿河屋": {
            "items": [{"itemname": "天空の城ラピュタ", "price": 1500}],
            "postage": 240,
            "sum_pos_out": 1500,
        },
        "高槻": {
            "items": [{"itemname": "耳をすませば", "price": 2480}],
            "postage": 350,
            "sum_pos_out": 2480,
        },
    },
...
item_list_case_4 = {
    ...
    "result": {
        ...
        "利府": {
            "items": [
                {"itemname": "ラジオの時間", "price": 2511},
                {"itemname": "マトリックス", "price": 1311},
            ],
            "postage": 300,
            "sum_pos_out": 3822,
        },
        "静岡本店": {
            "items": [{"itemname": "のぼうの城", "price": 1911}],
            "postage": 300,
            "sum_pos_out": 1911,
        },
    },
...
item_list_case_5 = {
    ...
    "result": {
        ...
        "sum_postage": 300,
        "うねめ通り": {
            "items": [{"itemname": "となりのトトロ", "price": 1800}],
            "postage": 300,
            "sum_pos_out": 1800,
        },
    },
