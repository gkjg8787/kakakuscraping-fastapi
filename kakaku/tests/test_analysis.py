...
def test_DaysItemLog():
    ...
    keyName = dbana.AnalysisKeyName
    start_dil = dbana.DaysItemLog(
        dict_list=period_end_log[keyName.PERIOD_LOG][keyName.START]
    )
    ...
    end_dil = dbana.DaysItemLog(
        dict_list=period_end_log[keyName.PERIOD_LOG][keyName.END]
    )
