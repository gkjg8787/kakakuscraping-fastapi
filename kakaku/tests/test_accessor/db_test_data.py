...
def add_data_online_store_postage(db):
    store_pos_list = [
        {"shop_id":1, "pref_id":1, "terms_id":1, "boundary":"1000>", "postage":500, "campaign_msg":"", "insert_proc_type":1},
        {"shop_id":1, "pref_id":1, "terms_id":2, "boundary":"1500>:1000<=", "postage":440, "campaign_msg":"", "insert_proc_type":1},
        {"shop_id":2, "pref_id":1, "terms_id":1, "boundary":"1500>", "postage":480, "campaign_msg":"", "insert_proc_type":1},
        {"shop_id":3, "pref_id":1, "terms_id":1, "boundary":"1500>", "postage":440, "campaign_msg":"", "insert_proc_type":1},
        {"shop_id":5, "pref_id":1, "terms_id":1, "boundary":"2000>", "postage":600, "campaign_msg":"", "insert_proc_type":1},
    ]
...
def add_online_store_data_set_of_pricelog(db):
    ...
    pricelog_list = [
        {
            "url_id": 1, "created_at":now,
            "uniqname":"one_item", "usedprice":1500, "newprice":-1,
            "taxin":True, "onsale":False, "salename":None,
            "issuccess":True, "trendrate":0, "storename":SURUGAYA,
        },
        {
            "url_id": 2, "created_at":now,
            "uniqname":"two_item", "usedprice":1200, "newprice":-1,
            "taxin":True, "onsale":False, "salename":None,
            "issuccess":True, "trendrate":0.177, "storename":SURUGAYA_CHIBA,
        },
        {
            "url_id": 3, "created_at":dbtimeTodatetime("2023-08-22 10:03:00"),
            "uniqname":"three_item", "usedprice":3000, "newprice":-1,
            "taxin":True, "onsale":False, "salename":None,
            "issuccess":True, "trendrate":-0.07, "storename":GEO,
        },
        {
            "url_id": 4, "created_at":now,
            "uniqname":"four_item", "usedprice":3300, "newprice":3400,
            "taxin":True, "onsale":False, "salename":None,
            "issuccess":True, "trendrate":0, "storename":NETOFF,
        },
        {
            "url_id": 5, "created_at":dbtimeTodatetime("2023-08-22 10:04:00"),
            "uniqname":"five_item", "usedprice":-1, "newprice":-1,
            "taxin":True, "onsale":False, "salename":None,
            "issuccess":True, "trendrate":0, "storename":BOOKOFF,
        },
    ]
    insert_pricelog_dict_list_sync(db, pldict_list=pricelog_list)
...
def add_data_daily_online_shop_info(db):
    shop_info_list = [
        {"shop_id":200910, "shop_name":"小山店", "url":"https://www.suruga-ya.jp/shop/200910", "insert_proc_type":2},
        {"shop_id":400407, "shop_name":"千葉中央店", "url":"https://www.suruga-ya.jp/shop/400407", "insert_proc_type":2},
        {"shop_id":400395, "shop_name":"ブックエコ浅川店", "url":"https://www.suruga-ya.jp/shop/400395", "insert_proc_type":1},
    ]
