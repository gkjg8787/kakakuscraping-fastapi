...
class SumItem:
    ...
    def createSum(self):
        ...
        for store in self.stores:
            sums[store.getName()]['postage'] = int(store.getPostage( sums[store.getName()]['sum'] ))
        self.sums = sums
    ...
    def getSum(self):
        ...
        for storename in self.sums.keys():
            allsum += int(self.sums[storename]['sum']) + int(self.sums[storename]['postage'])
        return allsum
    ...
    def getTextSum(self):
        ...
        for storename in self.sums.keys():
            ...
            text += '\n' + '{} : postage = {}'.format(storename, self.sums[storename]['postage'])
            setitems = [i.getName() for i in self.items if i.getStoreName() == storename]
    ...
    def getjson(self):
        ...
        for storename in self.sums.keys():
            ...
            setitems = [{'itemname':i.getName(),'price':i.getPrice()} for i in self.items if i.getStoreName() == storename]
